...
async fn test_spine_orientation_math_logic() -> Result<()> {
    ...
    let spine_dir = glam::DVec3::new(-0.0007869044836398384, 0.9998344368711255, -0.01817909865569267);
    let ydir = glam::DVec3::new(-1.4307578617685256e-5, 0.01817909302541243, 0.9998347465316791);
