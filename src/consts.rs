...
macro_rules! att_const {
    ($name:literal) => {
        db1_hash_const($name) as i32
    };
}

// 直接使用字符串字面量定义
const ATT_PAXI: i32 = att_const!("PAXI");
const ATT_PAAX: i32 = att_const!("PAAX");
const ATT_PBAX: i32 = att_const!("PBAX");
const ATT_PCAX: i32 = att_const!("PCAX");
const ATT_PLAX: i32 = att_const!("PLAX");

const ATT_PX: i32 = att_const!("PX");
const ATT_PY: i32 = att_const!("PY");
const ATT_PZ: i32 = att_const!("PZ");
const ATT_PZAXI: i32 = att_const!("PZAXI");
const ATT_PDIA: i32 = att_const!("PDIA");
const ATT_PHEI: i32 = att_const!("PHEI");
const ATT_PDIS: i32 = att_const!("PDIS");
const ATT_PCON: i32 = att_const!("PCON");
const ATT_PBOR: i32 = att_const!("PBOR");
const ATT_PPRO: i32 = att_const!("PPRO");
const ATT_DPRO: i32 = att_const!("DPRO");
const ATT_BTHK: i32 = att_const!("BTHK");
const ATT_BDIA: i32 = att_const!("BDIA");
const ATT_PTDI: i32 = att_const!("PTDI");
const ATT_PBDI: i32 = att_const!("PBDI");
const ATT_PBTP: i32 = att_const!("PBTP");
const ATT_PCTP: i32 = att_const!("PCTP");
const ATT_PBBT: i32 = att_const!("PBBT");
const ATT_PCBT: i32 = att_const!("PCBT");
const ATT_PXLE: i32 = att_const!("PXLE");
const ATT_PYLE: i32 = att_const!("PYLE");
const ATT_PZLE: i32 = att_const!("PZLE");
const ATT_PTDM: i32 = att_const!("PTDM");
const ATT_PBDM: i32 = att_const!("PBDM");
const ATT_POFF: i32 = att_const!("POFF");
const ATT_PTCDI: i32 = att_const!("PTCDI");
const ATT_DX: i32 = att_const!("DX");
const ATT_DY: i32 = att_const!("DY");
const ATT_PXTS: i32 = att_const!("PXTS");
const ATT_PYTS: i32 = att_const!("PYTS");
const ATT_PXBS: i32 = att_const!("PXBS");
const ATT_PYBS: i32 = att_const!("PYBS");
const ATT_ALLANG: i32 = att_const!("ALLANG");
const ATT_PRAD: i32 = att_const!("PRAD");
const ATT_DRAD: i32 = att_const!("DRAD");
const ATT_PWID: i32 = att_const!("PWID");
const ATT_PANG: i32 = att_const!("PANG");
const ATT_BANG: i32 = att_const!("BANG");
const ATT_PBOF: i32 = att_const!("PBOF");
const ATT_PCOF: i32 = att_const!("PCOF");
